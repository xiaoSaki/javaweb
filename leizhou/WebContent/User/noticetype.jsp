...
<div class="w1000">
	...
	<div class="header_bottom">
			...
			<a href="index.html"><img src="images/logo.jpg" width="294" height="49" alt="" title="雷州文化古城"></a>
              ...
              <li><a href="<%=basePath%>User/culture.jsp">文化</a></li>      
               ...
               <%--  <li><a href="<%=basePath%>tourism/showtourism.do">旅游</a></li>    --%>   
                ...
                <li><a href="<%=basePath%>User/Notice?action=show"><span class="navli">动态</span></a></li>          
...
<div class="container"> 		
		...
		<div class="content clearfix">
        	...
        	<li><h3><a target="notice" href="<%=basePath%>/User/Notice?action=showList&ntid=${noticetype.ntid}&pageNow=1">${noticetype.nt}</a></h3></li>
			...
			<iframe id="notice" name="notice" src="<%=basePath%>/User/Notice?action=showList&ntid=${firstnoticetypeid}&pageNow=1"  style="float:right;width:712px;height:665px;border:1px solid #cccccc;background-color:white;"></iframe>
