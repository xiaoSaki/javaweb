			...
			<c:if test="${zwjl != null }">
          	 ...
          	 <ul class="ul_zj clearfix">
				...
				<c:forEach items="${foodlist}" var="food">
					<li><a href="<%=basePath %>/User/Food?action=watch&ftid=${food.ftid}&aid=${food.aid}&pageNow=${pageNow }"><img src="${food.image }" width="220" height="140" class="imgs"><span>${food.fname }</span></a></li>
				</c:forEach>
				</c:if>
              </ul>
