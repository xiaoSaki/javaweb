...
<body>
	...
	<div class="w1000">
		...
		<div class="header_bottom">
				...
				<a href="<%=basePath%>"><img src="images/logo.jpg" width="294" height="49" alt="" title="雷州文化古城"></a>
	              ...
	              <li><a href="<%=basePath%>User/culture.jsp"><span class="navli">文化</span></a></li>      
	...
	<div class="container"> 		
		...
		<div class="banner_erji">
        	...
        	<img src="images/banner_erjiCulture.jpg" width="1000" height="187" alt="" title="">
            	...
            	<div class="leftnav">
                	...
                	<ul class="ul_left">
						<c:if test="${!empty articleList}">
							<c:forEach items="${articleList }" var="article" begin="2" end ="5">
