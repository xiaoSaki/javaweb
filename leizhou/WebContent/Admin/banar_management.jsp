...
<body>
	<div class="x-nav">
		<span class="layui-breadcrumb"> <a><cite>首页</cite></a> <a><cite>导航管理</cite></a>
	...
	<div class="x-body">
		...
		<button class="layui-btn"
			onclick="role_management_add('添加公告','banar_management_add.jsp','900','500')">
	...
	<table class="layui-table">
		...
		<tbody>
			<c:if test="${!empty banarList }">
				<c:forEach items="${banarList}" var="banarList" varStatus="loop">
					<tr>
						<td><input type="checkbox" name="check" value=${banarList.banarid }></td>
						<td>${banarList.banarid  }</td>
						<td>${banarList.image}</td>
						<td>${banarList.state }</td>
	

           
						<td class="td-manage"><a title="修改" href="javascript:;"
							onclick="role_management_update('修改公告','admBanarServlet?action=findupdateBanar&banarid=${banarList.banarid }','900','500')"
							class="ml-5" style="text-decoration: none"> <i
								class="layui-icon"><img src="images/look2.png" width="15"
									height="15"></i>
						</a> &ensp;<%-- <a title="删除" href="javascript:;"
							onclick="role_management_delete('删除','banarManageServlet?action=deleteUser&id=${banarList.id }','0','','0')"
							class="ml-5" style="text-decoration: none"> <i
								class="layui-icon"> --%>
								<a href ="admBanarServlet?action=deleteBanar&banarid=${banarList.banarid }"> <img src="images/shanchu.png" width="15"
									height="15">
						</a></td>
					</tr>
				</c:forEach>
