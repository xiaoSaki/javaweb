...
<body>
	<div class="x-body">
		<form action="userManageServlet?action=addUser" method="post" class="layui-form layui-form-pane">
			...
			<div class="layui-form-item">
				<label for="name" class="layui-form-label">性别
				</label>
				<div class="layui-input-inline">
			...
			<div class="layui-form-item">
				<label for="name" class="layui-form-label">email
				</label>
				<div class="layui-input-inline">
			...
			<div class="layui-form-item">
				<label for="name" class="layui-form-label">权限
				</label>
				<div class="layui-input-inline">
					<input type="text" id="status" name="status" autocomplete="off" class="layui-input">
				</div>
			</div>
					</tbody>
				</table>
