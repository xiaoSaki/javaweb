...
<body>
	<div class="x-body">
		<!-- <form action="userManageServlet?action=updateUser" method="post"
           ...
           <div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id="id" name="id" value='${user.id}' readonly="true"
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id="passwd" name="passwd"
						value='${user.passwd }' required lay-verify="required"
						autocomplete="off" class="layui-input">
				</div>
			</div>
			<div class="layui-form-item">
				<label for="name" class="layui-form-label"><span
					class="x-red">*</span>年龄 </label>
				<div class="layui-input-inline">
			...
			<div class="layui-form-item">
				<label for="name" class="layui-form-label">email </label>
				<div class="layui-input-inline">
			...
			<div class="layui-form-item">
				<label for="name" class="layui-form-label">权限 </label>
				<div class="layui-input-inline">
