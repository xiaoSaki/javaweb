...
<body>
	<div class="x-body">
		<form action="admTeamServlet?action=updateTeam" method="post"
			class="layui-form layui-form-pane">
			
			<div class="layui-form-item">
				<label for="name" class="layui-form-label"> <span
					class="x-red">*</span>Teamid
				</label>
				<div class="layui-input-inline">
					<input type="text" id="teamid" name="teamid" value='${team.teamid}' readonly="true"
           ...
           <div class="layui-form-item">
				<label for="name" class="layui-form-label"> <span
					class="x-red">*</span>团队内容
				</label>
				<div class="layui-input-inline">
					<input type="text" id="content" name="content" value='${team.content}' 
						required lay-verify="required" autocomplete="off"
						class="layui-input">
				</div>
			</tbody>
