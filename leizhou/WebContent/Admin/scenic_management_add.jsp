...
<body>
	<div class="x-body">
		<form action="scenicManageServlet?action=addScenic" method="post" enctype="multipart/form-data" class="layui-form layui-form-pane">
			<div class="layui-form-item">
				<label for="name" class="layui-form-label"> <span
					class="x-red">*</span>stid
				</label>
				<div class="layui-input-inline">					 
					<select name="stid" id="stid" float="right">
						<option value="1" selected>自然风光</option>
