...
<body>
	<div class="x-body">
		<form action="admArticleServlet?action=updateArticle" method="post"
			class="layui-form layui-form-pane">
			
			<div class="layui-form-item">
				<label for="name" class="layui-form-label"> <span
					class="x-red">*</span>aid
				</label>
				<div class="layui-input-inline">
					<input type="text" id="aid" name="aid" value='${article.aid}' readonly="true"
				...
				<div class="layui-input-inline">
					<input type="text" id="atid" name="atid" value='${article.atid}'
						required lay-verify="required" autocomplete="off"
						class="layui-input">
				</div>
				...
				<div class="layui-input-inline">
					<input type="text" id="publisher" name="publisher" value='${article.publisher}' 
						required lay-verify="required" autocomplete="off"
						class="layui-input">
				</div>
				...
				<div class="layui-input-inline">
					<input type="text" id="releasetime" name="releasetime" value='${article.releasetime}' 
						required lay-verify="required" autocomplete="off"
						class="layui-input">
				</div>
