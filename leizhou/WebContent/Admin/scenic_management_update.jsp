...
<body>
	<div class="x-body">
	<form action="scenicManageServlet?action=updateScenic" method="post" enctype="multipart/form-data" class="layui-form layui-form-pane">
...
<c:forEach items="${scenicList}" var="scenicList" varStatus="loop">
		<div class="layui-form-item">
			<label for="name" class="layui-form-label"> <span
				class="x-red">*</span>景点编号
			</label>
			<div class="layui-input-inline">
				<input type="text" id="sid" name="sid" value='${scenicList.sid}'
		...
		<div class="layui-form-item">
			<label for="name" class="layui-form-label"> <span
				class="x-red">*</span>景点类型
			</label>
			<div class="layui-input-inline">
				<input type="text" id="stid" name="stid" value='${scenicList.stid }'
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<input type="text" id="sname" name="sname"
					value='${scenicList.sname }' required lay-verify="required"
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<input type="text" id="image" name="image" value=${scenicList.image }
					required lay-verify="required" autocomplete="off"
					class="layui-input">
					
					<img style="width:95%;height:250px;margin-top: 10px;margin-left: 10px;" 
				src="${pageContext.request.contextPath }/${scenicList.image }" />
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<input type="text" id="aid" name="aid" value='${scenicList.aid  }'
					autocomplete="off" class="layui-input">
			</div>
		</div>
