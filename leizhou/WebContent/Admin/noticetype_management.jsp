...
<body>
	<div class="x-nav">
		<span class="layui-breadcrumb"> <a><cite>首页</cite></a> <a><cite>公告类型管理</cite></a>
	...
	<div class="x-body">
		...
		<button class="layui-btn"
			onclick="role_management_add('添加公告类型','noticetype_management_add.jsp','900','500')">
	...
	<table class="layui-table">
		...
		<tbody>
			<c:if test="${!empty noticetypeList }">
				<c:forEach items="${noticetypeList}" var="noticetypeList" varStatus="loop">
					<tr>
						<td><input type="checkbox" name="check" value=${noticetypeList.ntid }></td>
						<td>${noticetypeList.ntid }</td>
						<td>${noticetypeList.nt }</td>
			

           
						<td class="td-manage"><a title="修改" href="javascript:;"
							onclick="role_management_update('修改公告','admNoticeTypeServlet?action=findupdateNoticetype&nid=${noticetypeList.ntid }','900','500')"
							...
							class="ml-5" style="text-decoration: none"> <i
								class="layui-icon"> --%>
								<a href ="admNoticeTypeServlet?action=deleteNoticetype&ntid=${noticetypeList.ntid }"> <img src="images/shanchu.png" width="15"
									height="15">
						</a></td>
					</tr>
				</c:forEach>
