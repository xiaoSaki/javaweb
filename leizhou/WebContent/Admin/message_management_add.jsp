...
<body>
	<div class="x-body">
		<form action="messageManageServlet?action=addMessage" method="post" class="layui-form layui-form-pane">
			...
			<div class="layui-form-item">
				<label for="name" class="layui-form-label">留言内容
				</label>
				<div class="layui-input-inline">
					<input type="text" id="message" name="message" autocomplete="off" class="layui-input">
				</div>
			</div>
