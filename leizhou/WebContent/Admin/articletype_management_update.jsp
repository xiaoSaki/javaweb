...
<body>
	<div class="x-body">
		<form action="admArticletypeServlet?action=updateArticletype" method="post"
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id="atid" name="atid" value='${articletype.atid}' readonly="true"
           ...
           <div class="layui-form-item">
				<label for="name" class="layui-form-label"> <span
					class="x-red">*</span>文章类型
				</label>
				<div class="layui-input-inline">
					<input type="text" id="atype" name="atype" value='${articletype.atype}' 
						required lay-verify="required" autocomplete="off"
						class="layui-input">
				</div>
			</tbody>
