...
<body>
	<div class="x-nav">
		<span class="layui-breadcrumb"> <a><cite>首页</cite></a> <a><cite>文章类型管理</cite></a>
	...
	<div class="x-body">
		...
		<button class="layui-btn"
			onclick="role_management_add('添加文章类型','articletype_management_add.jsp','900','500')">
	...
	<table class="layui-table">
		...
		<tbody>
			<c:if test="${!empty articletypeList }">
				<c:forEach items="${articletypeList}" var="articletypeList" varStatus="loop">
					<tr>
						<td><input type="checkbox" name="check" value=${articletypeList.atid }></td>
						<td>${articletypeList.atid  }</td>
						<td>${articletypeList.atype}</td>

	

           
						<td class="td-manage"><a title="修改" href="javascript:;"
							onclick="role_management_update('修改公告','admArticletypeServlet?action=findupdateArticletype&atid=${articletypeList.atid }','900','500')"
							class="ml-5" style="text-decoration: none"> <i
								class="layui-icon"><img src="images/look2.png" width="15"
									height="15"></i>
						</a> &ensp;<%-- <a title="删除" href="javascript:;"
							onclick="role_management_delete('删除','articletypeManageServlet?action=deleteUser&id=${articletypeList.id }','0','','0')"
							class="ml-5" style="text-decoration: none"> <i
								class="layui-icon"> --%>
								<a href ="admArticletypeServlet?action=deleteArticletype&atid=${articletypeList.atid }"> <img src="images/shanchu.png" width="15"
									height="15">
						</a></td>
					</tr>
				</c:forEach>
