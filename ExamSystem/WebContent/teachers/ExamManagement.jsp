...
<!--   	<div class="round3"><a href="question_bankServlet?action=showQB&user_id=${user.user_id }">试题管理</a></div>-->
...
<iframe id="findallstu" name="findallstu"  src="question_bankServlet?action=showExam&user_id=${user.user_id }" frameborder="0">
</iframe>
