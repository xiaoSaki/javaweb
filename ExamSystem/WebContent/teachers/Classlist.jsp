...
<div class="m3">
	<div class="paging"><a href="tstudent_management?action=showStuClassL1&user_id=${user.user_id }&pageNum=${pageCount }&pageCount=${pageCount }">尾页</a></div>
	<div class="paging"><a href="tstudent_management?action=showStuClassL1&user_id=${user.user_id }&pageNum=${pageNum+1 }&pageCount=${pageCount }">下一页</a></div>
	<div class="paging">${pageNum }/${pageCount }</a></div>
	<div class="paging"><a href="tstudent_management?action=showStuClassL1&user_id=${user.user_id }&pageNum=${pageNum-1 }&pageCount=${pageCount }">上一页</a></div>
	<div class="paging"><a href="tstudent_management?action=showStuClassL1&user_id=${user.user_id }&pageNum=1&pageCount=${pageCount }">首页</a></div>
