...
<div class="m1">
 	...
 	<div class="round1"><a href="question_bankServlet?action=showEM&user_id=${user.user_id }">试卷管理</a></div>
 	
 	<div class="round2"><a href="question_bankServlet?action=showQB&user_id=${user.user_id }">题库管理</a></div>
 	
<!--   	<div class="round3"><a href="question_bankServlet?action=showST&user_id=${user.user_id }">试题管理</a></div>-->
...
<iframe id="findallstu" name="findallstu"  src="question_bankServlet?action=showQue_bank&user_id=${user.user_id }" frameborder="0">
</iframe>
