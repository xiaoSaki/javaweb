...
<div class="m1">
 	...
 	<div class="round3"><a href="tstudent_management?action=showCl&user_id=${user.user_id }">答题排名</a></div>
 	
 	<div class="round4"><a href="tstudent_management?action=showStuClass&user_id=${user.user_id }">班级情况</a></div>
...
<iframe id="findallstu" name="classlist"  src="tstudent_management?action=showStuClassL&user_id=${user.user_id }" frameborder="0">
