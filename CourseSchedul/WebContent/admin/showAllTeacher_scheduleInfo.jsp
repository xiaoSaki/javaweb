...
<!--主体内容-->
    ...
    <section class="publicMian ">
        ...
        <div class="right">
            ...
            <div class="search">
                ...
                <a href="addTeacher_schedule.jsp">添加教师任课表</a>
            </div>
            <!--学生-->
 ...
 <tr>
       ...
       <a href="UpdateTeacher_scheduleInfo.jsp?Tsno=<%=ts.getTsno() %>"><img src="img/xiugai.png" alt="修改" title="修改"/></a>
       <a href="deleteTeacher_scheduleInfoByTsnoServlet?Tsno=<%=ts.getTsno() %>" class="removeUser"><img src="img/schu.png" alt="删除" title="删除"/></a>
       </td> 
 </tr>
    <% 
       }
