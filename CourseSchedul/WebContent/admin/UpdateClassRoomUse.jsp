...
<section class="publicMian ">
   ...
   <form action="updateClassRoomUseServlet">
       <% 
       ...
       ClassRoomUseDto c = null;
       //System.out.println("wwwwwww");
       while(it.hasNext())
       {
    	  c = (ClassRoomUseDto)it.next();
    	  System.out.println("---------"+c.getRoomUserid());
    	  
    	  System.out.println("+++++++++"+cid);
    	  if((c.getRoomUserid().trim()).equals(cid))
    	   {
    ...
    %>
                ...
                <div>
                    ...
                    <input type="text" readOnly="true" name="cid" value=<%=c.getRoomUserid()%>/>
                    <span >*</span>
                </div>
                
                 <div>
                    <label for="useid">教室编号：</label>
                    <input type="text" name="useid" value=<%=c.getRoomid() %>>
                    <span >*</span>
                </div>
