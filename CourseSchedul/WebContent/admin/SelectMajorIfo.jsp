...
<!--头部-->
	...
	<div class="right">
		<div class="location">
			<strong>你现在所在的位置是:</strong> <span>查找专业信息页面</span>
		</div>
		...
		<%
            ...
            <p><strong>专业名称：</strong><span><%=sdto.getMajorName()%></span></p>
            <p><strong>标志位：</strong><span><%=sdto.getMIflag()%></span></p>
            <a href="findMajorIfoServlet">返回</a>
            <%
				}
            %>
        </div>
