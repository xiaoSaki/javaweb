...
<!--主体内容-->
    ...
    <section class="publicMian ">
        ...
        <div class="right">
            ...
            <div class="search">
                ...
                <a href="AddClassRoomUse.jsp">添加教室使用状态</a>
            </div>
            <!--用户-->
 ...
 <tr>
       ...
       <td><a href="ShowRoomUse2.jsp?cid=<%=s.getRoomUserid()%>"><img src="img/read.png" alt="查看" title="查看"/></a>
       <a href="UpdateClassRoomUse.jsp?cid=<%=s.getRoomUserid()%>"><img src="img/xiugai.png" alt="修改" title="修改"/></a>
       <a href="deleteClassRoomUseByidServlet?cid=<%=s.getRoomUserid()%>"><img src="img/schu.png" alt="删除" title="删除"/></a>
       </td> 
 </tr>
    <% 
       }
