...
<section class="publicMian ">
 ...
 %>：
        ...
        <div class="providerView">
            <p><strong>排课编号：</strong><span><%=sdto.getClassScheduleID() %></span></p>
            <p><strong>班级编号：</strong><span><%=sdto.getClassID() %></span></p>
            <p><strong>课程编号：</strong><span><%=sdto.getCourseID() %></span></p>
            <p><strong>星期**：</strong><span><%=sdto.getWeekday() %></span></p>
            <p><strong>上课节数：</strong><span><%=sdto.getClassTime() %></span></p>
            <p><strong>老师编号：</strong><span><%=sdto.getTeacherId() %></span></p>
            <p><strong>教室编号：</strong><span><%=sdto.getClassroomID() %></span></p>
            <a href="FindClassSchedule1.jsp">返回</a>
        </div>
        <%
        }
    }
