...
<section class="publicMian ">
 ...
 %>
            ...
            <p><strong>教室使用编号：</strong><span><%=u.getRoomUserid()%></span></p>
            <p><strong>教室编号：</strong><span><%=u.getRoomid() %></span></p>
            <p><strong>星期**：</strong><span><%=u.getWeekday() %></span></p>
            <p><strong>使用节数 ：</strong><span><%=u.getClasstime() %></span></p>
            <p><strong>使用状态：</strong><span><%=u.getUserstate()%></span></p>
            <a href="ShowAllClassRoomUse.jsp">返回</a>
        </div>
        <%
        }
    }
