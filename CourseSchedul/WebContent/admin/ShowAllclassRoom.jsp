...
<!--主体内容-->
    <section class="publicMian ">
        ...
        <div class="right">
            ...
            <div class="search">
                ...
                <a href="AddClassRoom.jsp">添加教室</a>
            </div>
            <!--用户-->
    ...
    while(it.hasNext())
    {
 	   s = (ClassRoomDto)it.next();
 	  // System.out.print("00000000kkk");
 %>
 <tr>
        <td ><input type="checkbox" name="check" value="<%=s.getRoomid() %>"></td>
        <td><%=s.getRoomid() %></td>
        <td><%=s.getRoomname() %></td>
        <td><%=s.getRoomtype() %></td>
        <td><%=s.getMaxnum() %></td>
       <td><a href="ShowClsaaRoom2.jsp?cid=<%=s.getRoomid()%>"><img src="img/read.png" alt="查看" title="查看"/></a>
